...
export default function NavBar() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('waypoint_theme') || 'light';
    setTheme(saved);
    ...
    <nav className="nav">
      <div className="nav-inner">
        ...
        <div className="nav-right">
          ...
          <button onClick={toggleTheme} className="icon-btn" title="Toggle theme" aria-label="Toggle theme" type="button">
            {theme === 'dark' ? (
